...
/**
 * Taken from http://stackoverflow.com/questions/3205191/android-and-mjpeg on 9/2/16.
 */
...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
                    ...
                    try {
                        ...
                        synchronized (mSurfaceHolder) {
                            try {
                                ...
                                c.drawColor(streamBackgroundColor);
    ...
    private void init(Context context) {
        ...
        streamBackgroundColor = Color.WHITE;
    ...
    public void setStreamBackgroundColor(int c) {
        streamBackgroundColor = c;
    }
